...
pool_size = 2  # Size of the pooling layer
num_classes = 1
...
def build_vuldee_cnn_model(sequence_length, embedding_dim, num_filters, kernel_size, pool_size, k_value, num_classes):
    # Input layer
    ...
    # Pooling layer
    pooled = layers.MaxPooling1D(pool_size=pool_size, name='max_pooling_layer')(conv)
    ...
    # Flatten the output
    flatten = layers.Flatten(name='flatten_layer')(conv2)
    ...
    expanded_vulnerability_location_matrix = layers.Lambda(lambda x: tf.expand_dims(x, -1))(vulnerability_location_matrix)
    ...
    # Create the model
    model = models.Model(inputs=[inputs, vulnerability_location_matrix], outputs=output, name='VulDeeLocator_CNN')
    ...
    #                      kernel_regularizer=regularizers.l1_l2(l1=0.01, l2=0.01),
    #                      activation='relu', name='dense_layer')(brnn)
    #
...
vuldee_model = build_vuldee_cnn_model(sequence_length, embedding_dim, num_filters, kernel_size, pool_size, k_value, num_classes)
