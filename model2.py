...
def build_vuldee_model(sequence_length, embedding_dim, rnn_units, k_value, num_classes):
    ...
    dense = layers.Dense(rnn_units, kernel_regularizer=regularizers.l1_l2(l1=0.01, l2=0.01), activation='relu', name='dense_layer')(gru)
...
vuldee_model.save('/home/httpiego/PycharmProjects/VulDeeDiegator/trained_models/trained_model_7.keras')
...
plt.savefig(f'/home/httpiego/PycharmProjects/VulDeeDiegator/trained_models/graphes/training_progress_7.png')
